...
| Auth | 會員資料 | 基本會員資料頁 | Y | Y | N | N | P1 | B | Sprint 1 | 可簡版先上 |
...
| KYC | 稽核 | 審核紀錄 audit log | N | Y | Y | N | P1 | A | Sprint 4 | 建議保留操作軌跡 |
...
| OMS | 訂單查詢 | C 端訂單列表 | Y | Y | N | N | P1 | B | Sprint 2 | 會員查詢 |
| OMS | 訂單查詢 | C 端訂單詳情 | Y | Y | N | N | P1 | B | Sprint 2 | 顯示狀態 |
...
| Contract | 文件查詢 | 合約列表 / 歷史合約 | Y | Y | N | N | P1 | B | Sprint 3 | C 端可調閱 |
| Contract | 文件查詢 | 合約下載 | Y | Y | N | N | P1 | B | Sprint 3 | 可下載 PDF |
...
| Invoice | 發票查詢 | 發票資訊顯示 | Y | Y | Y | N | P1 | B | Sprint 4 | 前後台可查 |
...
| Pricing | 加購 | 加購項目設定 | Y | Y | Y | N | P1 | B | Sprint 4 | 兒童座椅等 |
| Pricing | 加購 | 加購隨主單週期計價 | N | Y | N | N | P1 | A | Sprint 4 | 24H 週期 |
| Pricing | 折扣 | 折扣碼輸入 | Y | Y | N | N | P1 | B | Sprint 4 | C 端下單 |
| Pricing | 折扣 | 折扣碼驗證 | N | Y | N | N | P1 | A | Sprint 4 | 最低 0 元 |
...
| Flow | 財務標記 | Void | Y | Y | Y | N | P1 | B | Sprint 5 | 內部使用 |
| Flow | 財務標記 | Allowance | Y | Y | Y | N | P1 | B | Sprint 5 | 內部使用 |
...
| IoT | 資料同步 | 讀取剩餘能源 | N | Y | Y | Y | P1 | A | Sprint 5 | 告警使用 |
...
| IoT | 客服支援 | 客服控制台 | Y | Y | Y | N | P1 | B | Sprint 5 | 遠端排障 |
| IoT | 客服支援 | 強制還車按鈕 | Y | Y | Y | Y | P0 | B | Sprint 5 | 截斷計費 |
| IoT | 稽核 | 遠端操作紀錄 | N | Y | Y | N | P1 | A | Sprint 5 | 建議保留 log |
...
| Media | 取車存證 | 取車影片上傳 | Y | Y | N | Y | P1 | B | Sprint 5 | 可排在後段 |
| Media | 還車存證 | 還車照片上傳 | Y | Y | N | Y | P0 | B | Sprint 5 | C 端上傳 |
| Media | 還車存證 | 還車影片上傳 | Y | Y | N | Y | P1 | B | Sprint 5 | 可排在後段 |
...
| Asset | 調度作業 | 移機確認照片上傳 | Y | Y | Y | Y | P1 | B | Sprint 5 | 內部紀錄 |
...
| Notification | Email | 合約副本寄送 | N | Y | N | Y | P1 | A | Sprint 5 | 合約完成後 |
| Notification | Email | 發票副本寄送 | N | Y | N | Y | P1 | A | Sprint 5 | 發票開立後 |
| Notification | LINE OA | 預約成功通知 | N | Y | N | Y | P1 | A | Sprint 5 | C 端通知 |
| Notification | LINE OA | 取車提醒通知 | N | Y | N | Y | P1 | A | Sprint 5 | 排程或事件觸發 |
| Notification | LINE OA | 還車結算通知 | N | Y | N | Y | P1 | A | Sprint 5 | 結算完成 |
| Notification | LINE OA | 新訂單營運告警 | N | Y | N | Y | P1 | A | Sprint 5 | 內部群組 |
| Notification | LINE OA | 低電量告警 | N | Y | N | Y | P1 | A | Sprint 5 | IoT 事件 |
| Notification | LINE OA | 強制還車告警 | N | Y | N | Y | P1 | A | Sprint 5 | 關鍵事件 |
...
| 模組 | 功能分類 | 小功能 | FE | BE | 後台 | 串接 | Priority | Owner | Sprint | 備註 |
|---|---|---|---|---|---|---|---|---|---|---|
| Import | 匯入作業 | Excel / CSV 上傳頁 | Y | Y | Y | N | P1 | B | Sprint 4 | 過渡工具 |
| Import | 匯入作業 | 匯入解析器 | N | Y | N | N | P1 | A | Sprint 4 | 解析格式 |
| Import | 匯入作業 | 合法資料建單 | N | Y | N | N | P1 | A | Sprint 4 | 僅建立合法訂單 |
| Import | 匯入作業 | 異常資料略過 | N | Y | N | N | P1 | A | Sprint 4 | 不中斷整批 |
| Import | 匯入作業 | 錯誤清單頁 | Y | Y | Y | N | P1 | B | Sprint 4 | 顯示失敗原因 |
