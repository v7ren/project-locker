...
export function ProjectHomeLanding({
  ...
  return (
    <div className="mx-auto flex min-h-full w-full min-w-0 max-w-lg flex-col justify-center gap-6 px-4 py-16 pb-36 sm:gap-8 sm:px-6 sm:py-20">
